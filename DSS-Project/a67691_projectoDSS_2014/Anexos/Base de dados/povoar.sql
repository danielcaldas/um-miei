INSERT INTO Voluntarios
	...
	VALUES
        ...
        (19, "Carlitos Costa Afonso", '1990-02-23', "Bragança", "Rua Ernestim", "4715-300", "4º Ano", "913 232 123", "253 232 111", "Mal Desempregado", null, "Muito observações poderiam ser feitas pelo que nenhuma é", '2014-02-23', null);
...
INSERT INTO Funcionarios
	(Id, Nome, Comissao, Username, Password)
		VALUES 
			(1,"Jorge Daniel C. A. Caldas", "Comissão de construção", "jdc", "1234"),
            (2, "Henrique Firmino", "Comissão de Famílias", "asdf", "asdf"),
            (3, "Luís Fábio", "Comissão de Angariação de Fundos", "1234", "1234"),
            (4, "José Lucas", "Comissão de Famílias","umdolita", "umdolita"),
            (5, "Luísa José", "Comissão de Obras", "ha", "ha");
            
INSERT INTO Permissoes 
	(Id,Nome,Funcionario) 
		VALUES
			(1,'EDIT_VOLUNTARIOS_PERMISSIONS',1),
			(2,'CREATE_VOLUNTARIOS_PERMISSIONS',1),
			(3,'DELETE_VOLUNTARIOS_PERMISSIONS',1),
			(4,'CONSULT_VOLUNTARIOS_PERMISSIONS',1),
            (5,'CONSULT_VOLUNTARIOS_PERMISSIONS',2),
            (6,'CREATE_VOLUNTARIOS_PERMISSIONS',2);
...
INSERT INTO Candidaturas
	(Nr, Descricao, DataDecisao, FuncionarioAprovou, FuncionarioRegistou, Representante, Estado)
		VALUES
			(1, "Sem Descrição", '2014-01-20', 2, 2, 1, "Aprovada"),
			(2, "Sem Descrição", null, null, 2, 2, "Rejeitada"),
			(3, "Sem Descrição", '2014-07-20', 2, 2, 3, "Aprovada");
            
INSERT INTO Projetos
	(Nr,Orcamento, ValorFinal, Prestacao, DataInicio, DataEncerramento, Obs, Estado, FuncionarioEncerrou, FuncionarioRegistou, Candidatura)
		VALUES
			(1, 100000, 150000, 15000, '2014-02-01', '2014-05-02', "Correu tudo conforme o planeado", "Terminado", 1, 1, 2),
			(2, 30000, null, 1500, '2014-07-09', null, "Cambada de preguiçosos", "Em construção", null, 1, 3);
