...
public final class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addComponent(vButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE)
    ...
    /**
     * Método que imprime relatórios de operações num ficheiro de texto com nome do username do funcionário.
     * @param text, escreve relatório num ficheiro texto com o nome do funcionário. 
     */
    public void report (String text){
        String user = this.hfacade.rh_getUsername();
        try(PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(user+".txt", true)))) {
            out.println(text);
        }catch (IOException e) {}      
    }
