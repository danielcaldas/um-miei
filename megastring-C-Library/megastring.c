...
/***
**	Libraria de funções muito úteis para manipulação de arrays de caracteres
**  Helpful functions for manipulation of char arrays
**
**	@author jdc
**	@version 30/05/2014
**  1.0
...
//Main teste function - Unmark to test functions
/*int main()
{
